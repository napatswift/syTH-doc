วันที่ {number} เดือน {month} พ.ศ. {number} เวลา {number}:{number}

|0.25|0.25|0.5|
|---|---:|---|
|จำนวนผู้เข้้าร่วมประชุม|{number}+{number}||
|เห็นด้วย|{number}+{number}||
|ไม่เห็นด้วย|{number}+{number}||
|งดออกเสียง|{number}||
